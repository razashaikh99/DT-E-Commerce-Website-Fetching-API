    ...
    if (loading) {
        return <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
            <div className="text-center">
                ...
                <p className="text-gray-600 text-lg font-medium">Loading Feature products...</p>
            </div>
        </div>
    }
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <button
                                    ...
                                    className="w-full contact-gradient text-white font-semibold py-3 px-4 rounded-full hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3">
