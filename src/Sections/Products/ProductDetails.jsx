                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center space-x-4">
                                <span className="text-indigo-600 font-semibold">Brand Name</span>
                            ...
                            <div className="flex items-center space-x-4">
                                <span className="text-3xl font-bold text-indigo-600">$399</span>
                                <span className="text-gray-500 line-through">$499</span>
                            </div>

                            <p className="text-gray-700">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
                                vitae dui sit amet quam pretium dignissim. Curabitur eget
                                scelerisque erat.
                            </p>
